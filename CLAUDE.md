...
- Use the Supabase MCP server for schema, migrations, and RLS work when it's connected — don't hand-write SQL blind if the tool is available to check against the real project. Use supabase branching to test any new database changes.
